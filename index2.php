    ...
    <section class="top-bar-section">
      <ul class="right">
        ...
        <?PHP include "scripts/".(isset($_SESSION["name"]) && $_SESSION["name"] != "" ? "logout" : "login").".php"; ?>
	      <!--<li class=""><a id="login" href="#">Log In</a></li>-->
        <li class=""><a id="signup" href="#">Sign Up</a></li>
      </ul>
      <ul class="left">
...
<!-- Main -->
  <div class="main">
      ...
      <div class="content right small-12 medium-9 columns">
        <table>
          <thead>
            <tr>
              <th width="">Row</th>
              <th class="numbers" width="">Money</th>
              <th class="numbers" width="">Fuel</th>
              <th class="numbers" width="">Attackers</th>
              <th class="numbers" width="">Moral</th>
            </tr>
          </thead>
          <tbody>
            <tr>
    ...
    <div class="row full">
      <div class="sidebar  right small-12 columns">
        <div class="row full">
          <a href="#" class="small-4 columns button small">Scan</a>
          <a href="#" class="small-4 columns button small">Transport</a>
          <a href="#" class="small-4 columns button small">Attack</a>
        </div>
      </div>
    </div>
    <div class="row full">
      <div class="content left small-12 medium-12 columns">
        <table>
          <!--<thead>
            <tr>
              <th width="10%">Row</th>
              <th class="numbers" width="">Attackers</th>
              <th class="numbers" width="">Defenders</th>
              <th class="numbers" width="">Money</th>
              <th class="numbers" width="">Fuel</th>
              <th class="numbers" width="">MGS</th>
              <th class="numbers" width="">FGS</th>
              <th class="numbers" width="">Hospital</th>
              <th class="numbers" width="">H-lvl</th>
              <th class="numbers" width="">Attack</th>
              <th class="numbers" width="">Defense</th>
            </tr>
          </thead>-->
          <tbody>
	  	<?PHP include "ownedrows2.php"; ?>
          </tbody>
        </table>
      </div>
    </div>
